...
import IExpenseItem, { IExpenseCreateItem } from "../moels/expense";
import { getAllPayeesNames } from "../services/expense-utils";
            ...
            <Form onSubmit={handleExpenseCreate}>
                ...
                <Form.Group className="mb-3" controlId="payeeName">
                    ...
                    <Form.Select aria-label="Default select example" ref={payeeNameRef} >
                        ...
                        {
                            getAllPayeesNames(expenseItems).map((payeeName) => {
